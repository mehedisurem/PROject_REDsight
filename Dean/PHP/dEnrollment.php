...
$sql = "SELECT s.schoolID, COUNT(*) AS num_students FROM student st 
    ...
    Where AdmissionYear = '$year' AND AdmissionSemester = '$semester'
    GROUP BY s.SchoolID";
...
if($result->num_rows > 0){
    ...
    $NewTxt="No Record available for year: $year and semester: $semester! Try year 2020/21 instead";
    echo '<script>var myText = "'.$NewTxt.'"; document.getElementById("SchoolStats").innerHTML = myText;</script>';
}
...
if($deptResult->num_rows > 0){
    echo "<script>
        ...
        $NewTxt="No Record available for year: $year and semester: $semester! Try year 2020/21 instead";
    echo '<script>var myText = "'.$NewTxt.'"; document.getElementById("DeptStats").innerHTML = myText;</script>';
    }
...
if($programResult->num_rows > 0){
    ...
    $NewTxt="No Record available for year: $year and semester: $semester! Try year 2020/21 instead";
    echo '<script>var myText = "'.$NewTxt.'"; document.getElementById("ProgramStats").innerHTML = myText;</script>';
}
